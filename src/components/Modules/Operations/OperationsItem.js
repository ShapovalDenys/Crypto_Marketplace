...
const OperationsItem = ({ item, currentId, setCurrentId, expandAll, currentDate }) => {
  ...
  return (
    <>
    <div className={visibleInfo.account_status === "active" ? "operations__transaction" : "operations__transaction operations__transaction-disabled"} onClick={() => onClick()}>
    ...
    &&
        ...
        <div className={anim ? "account-info-animation-on account-info" : "account-info-animation-off account-info"}>
